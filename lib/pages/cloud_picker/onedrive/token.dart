...
class DefaultTokenManager extends ITokenManager {
  ...
  static const String _scope = "__scope";
  ...
  Future<void> _saveTokenMap(Map<String, dynamic> tokenObj) async {
    try {
      ...
      _secureStorage.write(key: _scope, value: tokenObj['scope']);
    } catch (err) {
  ...
  Future<void> clearStoredToken() async {
    try {
      await Future.wait([
        ...
        _secureStorage.delete(key: _scope),
      ]);
    } catch (err) {
  ...
  Future<String> getAccessToken() async {
    try {
      ...
      final scope = await _secureStorage.read(key: _scope);
